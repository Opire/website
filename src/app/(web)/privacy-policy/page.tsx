    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Container>
          ...
          <p>
            Your privacy is important to us. It is Opire LLC's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://opire.dev, and other sites we own and operate.
          </p>
          <p>
          ...
          <p>
            This policy is effective as of August 17, 2024
          </p>
          <p>
          ...
          <p>
            The personal information we collect is stored and/or processed in Spain, United States, Ireland, and Sweden, or where we or our partners, affiliates, and third-party providers maintain facilities.
          </p>
          <p>
          ...
          <p>
            <strong>Non-discrimination:</strong> We will not discriminate against you for exercising any of your rights over your personal information. Unless your personal information is required to provide you with a particular service or offer (for example processing transaction data), we will not deny you goods or services and/or charge you different prices or rates for goods or services, including through granting discounts or other benefits, or imposing penalties, or provide you with a different level or quality of goods or services.
          </p>
          <p>
          ...
          <h2>Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)</h2>
          <h3>Data Controller / Data Processor</h3>
          <p>
            The GDPR distinguishes between organisations that process personal information for their own purposes (known as "data controllers") and organisations that process personal information on behalf of other organisations (known as "data processors"). We, Opire LLC, located at the address provided in our Contact Us section, are a Data Controller and/or Processor with respect to the personal information you provide to us.
          </p>
          ...
          <h2>Additional Disclosures for U.S. States Privacy Law Compliance</h2>
          <p>
          ...
          <h3>California Privacy Laws - CPPA</h3>
          <p>
